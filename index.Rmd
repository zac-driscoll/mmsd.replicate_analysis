...
data_yr <-  calculate_rep_exceedance(
  start_date = "2015-01-01", 
  end_date = "2021-12-31",
  grouping = c("year"))

data_param <-  calculate_rep_exceedance(
  start_date = "2015-01-01", 
  end_date = "2021-12-31",
  grouping = c("parameter"))

data_wtb <-  calculate_rep_exceedance(
  start_date = "2015-01-01", 
  end_date = "2021-12-31",
  grouping = c("water_body"))

data_site<-  calculate_rep_exceedance(
  start_date = "2015-01-01", 
  end_date = "2021-12-31",
  grouping = c("sitecode","site_type"))
...
data_param_site <- calculate_rep_exceedance(
  start_date = "2015-01-01", 
  end_date = "2021-12-31",
  grouping = c("parameter","sitecode","depth"))


```

### General Analysis
<h3> Number of Exceedances over time </h3>
...
crosstalk::filter_slider("range_exceed2", "Percent Exceedance", 
...
by year. Red cells indicate a higher percentage of samples exceeding the standard. <br>
...
A heatmap showing the percentage of samples that exceeded the replicate standard
by waterbody Red cells indicate a higher percentage of samples exceeding the standard. <br>
```{r, fig.width = 10, fig.height = 7, warning= FALSE}
p <- data_yr_wtb[[2]] %>%
  group_by(water_body) %>%
  mutate(sum_exceeds = sum(perc_exceeds))  %>%
...
samples exceeding the standard. <br>
